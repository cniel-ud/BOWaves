"""
Here is Carlos' old notebook for testing the different classifiers.

My goal is to use this same structure to test his old emotion data clf on the cue data.
Will need to keep in mind the different sampling rate, etc.
"""
